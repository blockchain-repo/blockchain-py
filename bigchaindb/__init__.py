...
# basically, the port number is 9784
config = {
    'server': {
        # Note: this section supports all the Gunicorn settings:
        #       - http://docs.gunicorn.org/en/stable/settings.html
        'bind': os.environ.get('BIGCHAINDB_SERVER_BIND') or 'localhost:9784',
    ...
    'api_endpoint': os.environ.get('BIGCHAINDB_API_ENDPOINT') or 'http://localhost:9784/api/v1',
    'backlog_reassign_delay': 30,
    'restore_server': {
        'bind': os.environ.get('BIGCHAINDB_RESTORE_SERVER_BIND') or 'localhost:9786',
    ...
    'restore_endpoint': os.environ.get('BIGCHAINDB_RESTORE_ENDPOINT') or 'http://localhost:9786/api/v1/collect',
}
